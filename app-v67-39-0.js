...
async function v55LoadRanking(){
 ...
 try{
   ...
   const explain=isAnnual
     ? '<b>O Ranking Anual soma os pontos dos rankings mensais do ano.</b> Cada janela operacional validada de 24 horas pode gerar no máximo <b>1 ponto</b>, desde que exista pelo menos um Treino de Força válido ou Cardio válido. Core é complementar e não pontua.'
     : '<b>Cada janela operacional validada de 24 horas pode gerar no máximo 1 ponto no Ranking de Frequência.</b> Somente atividades realizadas durante uma validação de serviço ativa entram no ranking. A validação exige o QR fixo da unidade e confirmação de localização no momento da leitura. Nos treinos prontos e personalizados, é necessário registrar pelo menos <b>3 exercícios e 6 séries</b>. No treino livre, é necessário informar grupo muscular e registrar pelo menos <b>20 minutos</b>. No <b>Cardio</b>, Esteira, Bicicleta Ergométrica e Simulador de Remo precisam ter pelo menos <b>30 minutos</b>; na Esteira também são registrados distância, calorias e pace. <b>Treino de Força e Cardio são as atividades que podem gerar o ponto.</b> O <b>Core Operacional</b> continua registrado normalmente no Histórico, Evolução e Feed, mas é atividade complementar e <b>não gera ponto</b>. Fazer Treino + Cardio, dois treinos ou vários cardios dentro da mesma janela continua valendo no máximo <b>1 ponto</b>. Atividades sem validação ativa ou que não atinjam os critérios valem 0 ponto.';
