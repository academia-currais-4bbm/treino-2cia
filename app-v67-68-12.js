...
function startPlanWorkout(){
  // V67.68.12 — início robusto também para treinos personalizados.
  // O áudio deve parar imediatamente quando o treino começa.
  ...
  // Persiste a sessão antes de abrir a tela: se Android/PWA interromper a
  // navegação, o treino ainda poderá ser retomado sem perda.
  ...
  try{
    ...
    // Mantém a sessão salva e pausada para permitir retomada.
...
document.addEventListener('visibilitychange',()=>{
  if(document.visibilityState==='hidden'){
    // V67.68.12 — ao sair/minimizar o app, treino em andamento fica PAUSADO
