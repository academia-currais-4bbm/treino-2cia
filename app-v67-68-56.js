...
if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw-v67-68-56.js', {updateViaCache:'none'}));
...
async function v6743Registration(){
  ...
  if(!reg)reg=await navigator.serviceWorker.register('sw-v67-68-56.js', {updateViaCache:'none'});
...
/* ===== V67.68.56 — GESTÃO DE MILITARES PRO ===== */
