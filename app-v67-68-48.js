...
if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw-v67-68-48.js', {updateViaCache:'none'}));
...
localStorage.setItem('t2_app_version','v67.68.48');
...
/* ===== V67.68.48 — FEED ESPORTIVO PRO: filtros, ordenação e resumo ===== */
...
async function v6743Registration(){
  ...
  if(!reg)reg=await navigator.serviceWorker.register('sw-v67-68-48.js', {updateViaCache:'none'});
