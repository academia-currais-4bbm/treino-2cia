...
function v6758ShowMotivation(){
  if(!V67581_MOTIVATION_ELIGIBLE||v6758MotivationShown||!cloudSession?.token)return false;
  ...
  v6758MotivationTimer=setTimeout(releaseSplash,3000);
  return true;
}
