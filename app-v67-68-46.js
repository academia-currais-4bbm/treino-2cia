...
if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw-v67-68-46.js', {updateViaCache:'none'}));
...
localStorage.setItem('t2_app_version','v67.68.46');
...
async function v6743Registration(){
  ...
  if(!reg)reg=await navigator.serviceWorker.register('sw-v67-68-46.js', {updateViaCache:'none'});
