...
function v6750ClosePostWorkout(goHome=false){document.getElementById('v6750PostWorkout')?.classList.remove('show');if(goHome)v676835GoHome()}
function v6750OpenFeed(){v6750ClosePostWorkout();v676835GoHome();setTimeout(()=>document.querySelector('.sports-feed-shell')?.scrollIntoView({behavior:'smooth',block:'start'}),180)}
