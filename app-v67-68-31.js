...
document.addEventListener('visibilitychange',()=>{
  if(document.visibilityState==='hidden'){
    // V67.68.31 — grava o ponto EXATO antes de o Android/PWA suspender a página.
    try{
...
/* ===== V67.68.31 — CHECKPOINT DURÁVEL DO TREINO PERSONALIZADO ===== */
...
function restoreNavigationState(force=false){
  // V67.68.31 — restauração do personalizado é LOCAL e não depende de login/cloud.
  ...
  // V67.68.31 — ao ATUALIZAR a página durante um treino estruturado/personalizado,
