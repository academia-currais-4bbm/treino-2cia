...
function startPlanWorkout(){
  // V67.68.20 — início resiliente: a abertura visual do exercício é o marco de
...
function nextPlanExercise(){
  ...
  if(activePlanIndex < activePlanExercises.length-1){
    activePlanIndex++;
    // V67.68.20 — cada exercício novo começa obrigatoriamente na série 1.
    currentSet=1;
    pauseTimer();
...
function openExercise(id,inPlan=false){
  ...
  // V67.68.20 — entra na tela de execução IMEDIATAMENTE. Assim nenhuma rotina
...
function completeSet(){
  ...
  if(currentSet<currentExercise.sets){
    ...
    // V67.68.20 — a última série também conta visualmente como concluída e
...
localStorage.setItem('t2_app_version','v67.68.20');
