...
function nextPlanExercise(){
  ...
  if(activePlanIndex < activePlanExercises.length-1){
    ...
    // V67.68.27 — ao ENTRAR em um novo exercício, o relógio fica no tempo
...
// V67.68.27 — nos personalizados, dispara o descanso APÓS toda a cadeia da série.
...
function v676824StartCustomRestAfterSet(seconds=null){
  ...
  // V67.68.27 — mesmo ciclo dos treinos prontos: cada conclusão/pulo
...
// V67.68.27 — descanso usa o mesmo comando-base do treino pronto.
...
localStorage.setItem('t2_app_version','v67.68.27');
