...
const SHELL=[
  ...
  'icon-192.png',
  'icon-512.png',
  'notification-badge-v676837.png',
  'notification-icon-v676837.png',
...
function isAppShell(url){
  return url.pathname.endsWith('/') ||
    ...
    url.pathname.endsWith('/app-v67-68-40.js') ||
    url.pathname.endsWith('/styles-v67-68-5.css') ||
...
self.addEventListener('push',event=>{
  event.waitUntil((async()=>{
    ...
    const options={
      ...
      icon:new URL('notification-icon-v676837.png',self.registration.scope).href,
      color:'#C8102E',
      vibrate:[180,80,180],
      renotify:true
    };
