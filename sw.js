const CACHE='t2cia-v67.60.10';
const RUNTIME='t2cia-runtime-v67.60.10';
const SHELL=[
  './',
  'index.html',
  'styles-v67-60-10.css',
  'app-v67-60-10.js',
  'data.js',
  'cloud-config.js',
  'manifest.json',
...
function isAppShell(url){
  return url.pathname.endsWith('/') ||
    ...
    url.pathname.endsWith('/app-v67-60-10.js') ||
    url.pathname.endsWith('/styles-v67-60-10.css') ||
