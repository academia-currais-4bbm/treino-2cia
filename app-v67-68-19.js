...
function startPlanWorkout(){
  // V67.68.19 — início resiliente: a abertura visual do exercício é o marco de
...
function openExercise(id,inPlan=false){
  ...
  // V67.68.19 — entra na tela de execução IMEDIATAMENTE. Assim nenhuma rotina
...
localStorage.setItem('t2_app_version','v67.68.19');
