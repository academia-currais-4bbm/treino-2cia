...
// V67.68.24 — nos personalizados, dispara o descanso APÓS toda a cadeia da série.
...
if('serviceWorker'in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('sw-v67-68-24.js', {updateViaCache:'none'}));
...
localStorage.setItem('t2_app_version','v67.68.24');
...
async function v6743Registration(){
  ...
  if(!reg)reg=await navigator.serviceWorker.register('sw-v67-68-24.js', {updateViaCache:'none'});
