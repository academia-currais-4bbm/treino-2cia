...
/* ===== V67.60.4 — PAUSAR / RETOMAR / CANCELAR TREINO ===== */
...
function restoreNavigationState(force=false){
  ...
  if(!force && !NAV_RESTORE_ON_BOOT){
    // V67.60.4: treino preservado volta como cartão na Home; o militar decide retomar ou cancelar.
