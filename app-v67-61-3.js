...
// V67.61.3 — uma nova execução do documento no PWA é uma abertura real.
...
document.addEventListener('visibilitychange',()=>{
  if(document.visibilityState==='hidden'){
    // V67.61.3 — trocar temporariamente para WhatsApp/câmera/etc. NÃO pausa,
