...
function startPlanWorkout(){
  ...
  if(existing){
    if(v67687CanResumeActivePlan(existing)){
      if(confirm('Já existe um treino em andamento. Deseja retomá-lo?')){
        if(v67604ResumeActivePlan()){
          v67621StopMusic(true);
          return;
        }
        // Se a retomada falhar apesar do estado parecer válido, limpa o estado
        // quebrado e permite iniciar normalmente o treino que estava na tela.
