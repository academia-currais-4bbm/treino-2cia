...
function v67621GetMusic(){
  ...
  const a=new Audio('trilha-treino-2cia.mp3?v=67.62.1');
  a.loop=true;a.preload='none';a.volume=0.24;
  a.addEventListener('play',v67621UpdateMusicButton);
...
async function v67621PlayMusic(){
  if(!v67621MusicUnlocked||!v67621ShouldPlayMusic())return false;
  try{await v67621GetMusic().play();v67621UpdateMusicButton();return true}catch(e){return false}
}
...
function v67621ToggleMusic(){
  ...
  if(next&&!v67621WorkoutActive())v67621PlayMusic();else v67621StopMusic(false);
  v67621UpdateMusicButton();
}
...
function v67621UnlockMusic(){
  v67621MusicUnlocked=true;
  if(v67621ShouldPlayMusic())v67621PlayMusic();
}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',v67621InstallMusicButton,{once:true});
else v67621InstallMusicButton();
window.addEventListener('pointerdown',v67621UnlockMusic,{once:true,capture:true});
window.addEventListener('keydown',v67621UnlockMusic,{once:true,capture:true});
document.addEventListener('visibilitychange',()=>{
  if(document.visibilityState==='hidden')v67621StopMusic(false);
  else if(!v67621WorkoutActive())v67621PlayMusic();
});
window.addEventListener('pageshow',()=>{if(!v67621WorkoutActive())v67621PlayMusic()});
