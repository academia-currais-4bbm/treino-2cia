...
function v67621GetMusic(){
  ...
  const a=new Audio('trilha-treino-2cia.mp3?v=67.62.2');
  a.loop=true;a.preload='auto';a.volume=0.24;
  a.addEventListener('play',()=>{v67621MusicUnlocked=true;v67622RemoveGestureUnlock();v67621UpdateMusicButton()});
...
function v67622InstallGestureUnlock(){
  ...
  window.addEventListener('touchend',v67622GestureUnlock,true);
  window.addEventListener('keydown',v67622GestureUnlock,true);
}
function v67622RemoveGestureUnlock(){
  if(!v67622MusicGestureInstalled)return;
  v67622MusicGestureInstalled=false;
  window.removeEventListener('pointerdown',v67622GestureUnlock,true);
  window.removeEventListener('touchend',v67622GestureUnlock,true);
  window.removeEventListener('keydown',v67622GestureUnlock,true);
}
...
document.addEventListener('visibilitychange',()=>{
  ...
  else if(!v67621WorkoutActive()){
    v67622InstallGestureUnlock();
    v67621PlayMusic(true);
  }
});
window.addEventListener('pageshow',()=>{
  if(!v67621WorkoutActive()){
    v67622InstallGestureUnlock();
    v67621PlayMusic(true);
  }
});
